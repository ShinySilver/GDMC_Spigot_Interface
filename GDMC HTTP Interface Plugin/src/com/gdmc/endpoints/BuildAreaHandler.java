...
public class BuildAreaHandler extends HandlerBase {
	public static class BuildArea {
		...
		public String toString() {
			return "BuildArea{" + "areaX=" + xFrom + ", areaZ=" + zFrom + ", areaSizeX=" + xTo + ", areaSizeZ=" + zTo
					+ '}';
		}
	}
...
//    private static final Logger LOGGER = LogManager.getLogger();
	...
	public void internalHandle(HttpExchange httpExchange) throws IOException {
		...
		if (buildArea == null) {
			throw new HandlerBase.HttpException(
					"No build area is specified. Use the buildarea command inside Minecraft to set a build area.", 404);
		}
